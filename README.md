<h1 align="center">MAXSTACK</h1>

<p align="center">
	The AI-native web app stack
</p>

You can read the full docs on [maxstack.dev](https://wwww.maxstack.dev)

## Usage

`npx maxstack init`

then cd to your new folder and run
